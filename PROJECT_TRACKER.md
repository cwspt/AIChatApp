...
| NEXT-P2-004 | UI 文件拆分 | In Progress | 已将带单测覆盖的列表分组、长气泡导航目标、折叠摘要和分叉来源标签纯逻辑拆到 `UiListModels.kt`，并将工具调用解析、摘要、引用和视觉类型模型拆到 `ToolCallModels.kt`；后续继续拆 chat/settings/drawer/markdown/components |
